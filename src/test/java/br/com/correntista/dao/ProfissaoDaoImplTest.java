...
//    @Test -> não é possível excluir por ter chave estrangeira
    ...
    public void testPesquisarTodo() {
        ...
        sessao = HibernateUtil.abrirSessao();
        List<Profissao> listaProfissoes = profissaoDao.pesquisarTodo(sessao);
        sessao.close();
        assertTrue(!listaProfissoes.isEmpty());
    }
